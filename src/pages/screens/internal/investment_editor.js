...
export default function InvestmentEditor({caption = null, value = null, initialColor = "#FF0000"}) {
        ...
        <div className="flex flex-col justify-between h-full w-full p-4 mt-4 rounded-2xl bg-primary-0 dark:bg-primary-1">
            <form className="flex flex-col">
                <div className="flex justify-between">
                    ...
                    <input value={caption} className="self-center ml-3 w-[95%] font-bold ps-3 p-1.5 rounded-lg text-2xl bg-secondary-0 dark:bg-secondary-1 border border-accent-b-0 dark:border-accent-b-1 text-accent-fg-0 dark:text-accent-fg-1 placeholder-accent-dim-0 dark:placeholder-accent-dim-1 focus:ring-accent-0 focus:border-accent-0" placeholder="Titulo"/>
                </div>
                ...
                <div className="flex justify-between mt-4">
                    ...
                    <input value={value} className="self-center w-1/2 ps-3 p-1.5 rounded-lg text-sm bg-secondary-0 dark:bg-secondary-1 border border-accent-b-0 dark:border-accent-b-1 text-accent-fg-0 dark:text-accent-fg-1 placeholder-accent-dim-0 dark:placeholder-accent-dim-1 focus:ring-accent-0 focus:border-accent-0"/>
                </div>
