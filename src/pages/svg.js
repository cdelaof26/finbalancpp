...
function envelope(classNameData) {
    return (
...
function user_circle(classNameData) {
    return (
        <svg className={classNameData} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
function question_mark_circle(classNameData) {
    return (
        <svg className={classNameData} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
function user_plus(classNameData) {
    return (
        <svg className={classNameData} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
function arrow_right_end_on_rectangle(classNameData) {
    return (
        <svg className={classNameData} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
function chart_pie(classNameData) {
    return (
        <svg className={classNameData} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
function inbox_arrow_down(classNameData) {
    return (
        <svg className={classNameData} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
function banknotes(classNameData) {
    return (
        <svg className={classNameData} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
function inbox_stack(classNameData) {
    return (
        <svg className={classNameData} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
function arrow_trending_up(classNameData) {
    return (
        <svg className={classNameData} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
function currency_dollar(classNameData) {
    return (
        <svg className={classNameData} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
function eye_slash(classNameData) {
    return (
        <svg className={classNameData} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
function credit_card(classNameData) {
    return (
        <svg className={classNameData} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
 ...
 * @param classNameData the CSS class data for the svg element
 * @returns {JSX.Element}
 * @constructor
 */
